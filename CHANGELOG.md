...
## [9.1.6](https://github.com/illiteratewriter/reactstrap/compare/v9.2.2...v9.1.6) (2024-04-07)
...
* remove Jumbotron component ([#2118](https://github.com/illiteratewriter/reactstrap/issues/2118))

### Features

* **accordion:** add `flush` support and `stayOpen` support ([a6050f5](https://github.com/illiteratewriter/reactstrap/commit/a6050f5ea6cc9ceba63db702663242b571e9f602))
* add forwardRef to all components that contain innerRef ([17a141a](https://github.com/illiteratewriter/reactstrap/commit/17a141acbe9af558c1c3e7cb34fc051c1b1d8d0e))
* add List and ListInlineItem components ([#2033](https://github.com/illiteratewriter/reactstrap/issues/2033)) ([a97a834](https://github.com/illiteratewriter/reactstrap/commit/a97a8345f3998e9388d42550b8e70aaa62a5be50))
* add positionFixed prop to Tooltip and Popover ([#2039](https://github.com/illiteratewriter/reactstrap/issues/2039)) ([a330ce6](https://github.com/illiteratewriter/reactstrap/commit/a330ce65e1a38dd0a14e1bc0ca37f86740964df1))
* Add typescript definitions ([#1976](https://github.com/illiteratewriter/reactstrap/issues/1976)) ([2a47626](https://github.com/illiteratewriter/reactstrap/commit/2a47626dc088f1983239f606c91f6294c7e756d7))
* **bs5:** add accordion ([#2105](https://github.com/illiteratewriter/reactstrap/issues/2105)) ([1c09448](https://github.com/illiteratewriter/reactstrap/commit/1c09448fdcfbe5db68e057911546ad2d036e805e))
* **bs5:** add Offcanvas ([9a4bcca](https://github.com/illiteratewriter/reactstrap/commit/9a4bcca7b299f358bb3b953996a9d4afb2f7b602))
* **bs5:** change .close to .btn-close ([#2116](https://github.com/illiteratewriter/reactstrap/issues/2116)) ([be4df60](https://github.com/illiteratewriter/reactstrap/commit/be4df609ac21cdcbb56c635600dce8eae6c819f1))
* **bs5:** change no-gutters class to gx-0 in Row ([#2119](https://github.com/illiteratewriter/reactstrap/issues/2119)) ([85b8933](https://github.com/illiteratewriter/reactstrap/commit/85b8933304cb0ae529b6f5d24574b98a929a35bc))
* **bs5:** convert .sr-only to .visually-hidden ([702ad55](https://github.com/illiteratewriter/reactstrap/commit/702ad553b37a25ab516fc147201622ad122c39d1))
* **bs5:** Convert Dropdown & DropdownMenu to RTL ([7417984](https://github.com/illiteratewriter/reactstrap/commit/741798459178b825f53cedaa54c33326a81b8564))
* **bs5:** Rename margin utils ([35a37ef](https://github.com/illiteratewriter/reactstrap/commit/35a37ef21d751207b4951aa5b6aca34b9efd4d5a))
* **bs5:** Replace .btn-block with utility classes ([4dc1dcd](https://github.com/illiteratewriter/reactstrap/commit/4dc1dcd21bd51d7bd88b40a0b249e02b0edaf0b0))
* **bs5:** replace form-group class with mb-3 ([cbcb2e3](https://github.com/illiteratewriter/reactstrap/commit/cbcb2e3abc240f64833967996cce4c4878529170))
* **bs5:** Support xxl breakpoint ([4fb7cdd](https://github.com/illiteratewriter/reactstrap/commit/4fb7cdd7791d11071fdc473e990ca704e0374fc2))
* **bs5:** update badge classes ([#2117](https://github.com/illiteratewriter/reactstrap/issues/2117)) ([7859900](https://github.com/illiteratewriter/reactstrap/commit/785990048f88699df5f31111c525fdaa7d34a640))
* **bs5:** Update tooltip/popover arrow classes ([9ad870e](https://github.com/illiteratewriter/reactstrap/commit/9ad870ea3518a9a81716e945d46c06a7c341d7fe))
* **Button:** onClick of inner button returns value of props.onClick. ([f09cdd6](https://github.com/illiteratewriter/reactstrap/commit/f09cdd6c2fb496948760e962383b1fa657a2c5e0))
* **carousel:** add Bootstrap5 updates ([a698814](https://github.com/illiteratewriter/reactstrap/commit/a69881437fe3d861c44e9493c1983c7c7d13ae34))
* **Carousel:** Add dark prop ([01f64df](https://github.com/illiteratewriter/reactstrap/commit/01f64dfcf89a44e41754f7669d46830af942b826))
* **CloseButton:** add close button ([9e656f5](https://github.com/illiteratewriter/reactstrap/commit/9e656f50c4d35cb8e32b826316f8761e80af9c3e))
* **collapse:** add horizontal collapse ([f780187](https://github.com/illiteratewriter/reactstrap/commit/f7801874dc5b8777c8624709f99d62feb19b3563))
* **Dropdown:** Add backwards compatible left & right ([f8b415f](https://github.com/illiteratewriter/reactstrap/commit/f8b415f9a989b4363adc4ba79c190db9fb0d38f0))
* **Dropdown:** add support for listbox or menu role ([#2077](https://github.com/illiteratewriter/reactstrap/issues/2077)) ([fd9e988](https://github.com/illiteratewriter/reactstrap/commit/fd9e9888b7712905a85684f7822fc75fde38c069))
* **Dropdown:** Added container prop to DropdownMenu using React.portal ([#2016](https://github.com/illiteratewriter/reactstrap/issues/2016)) ([bd313c2](https://github.com/illiteratewriter/reactstrap/commit/bd313c23e5d1dee984e65e5fdc167fe83f3831a9))
* **DropdownItem:** Add support for .dropdown-item-text ([#1971](https://github.com/illiteratewriter/reactstrap/issues/1971)) ([c41b172](https://github.com/illiteratewriter/reactstrap/commit/c41b172180b92ba3f53444ca8f409c1cd10f895d))
* **DropdownMenu:** add-dark-prop ([2e22d7b](https://github.com/illiteratewriter/reactstrap/commit/2e22d7bbfa3764399c41ae8d360346c255e4bc44))
* **forms:** Add support for floating labels ([1cc8a14](https://github.com/illiteratewriter/reactstrap/commit/1cc8a14577b044d10fdea4f804996f49afca04d8))
* **ListGroup:** Add ListGroupNumbered ([02b3b71](https://github.com/illiteratewriter/reactstrap/commit/02b3b71e62668493f61253a6a67919ec4c18ba97))
* **modal:** add 'aria-modal="true"' to modal ([2a43591](https://github.com/illiteratewriter/reactstrap/commit/2a43591f6d6f2fd6e1e5f7f3bd65caf9efd7f7ab))
* **modal:** add fullscreen option to Modal component ([a580f23](https://github.com/illiteratewriter/reactstrap/commit/a580f23a8eeefae21b0c6ba36b8da470ee925cd2))
* **Modal:** Add trapFocus prop ([#2073](https://github.com/illiteratewriter/reactstrap/issues/2073)) ([6e0fd56](https://github.com/illiteratewriter/reactstrap/commit/6e0fd565b66c9a16b3187adcb71d52d2d9db2902))
* **Modal:** Allow passing in an element selector to append mod… ([#1817](https://github.com/illiteratewriter/reactstrap/issues/1817)) ([8f8cc98](https://github.com/illiteratewriter/reactstrap/commit/8f8cc989821504095d649ec70c5091d7cffdc516))
* **Modal:** match container behaviour to targetPropType like of Popover and Tooltip ([#1844](https://github.com/illiteratewriter/reactstrap/issues/1844)) ([6ea2488](https://github.com/illiteratewriter/reactstrap/commit/6ea2488c97eb24b0c8f15bbf26b2768921932607))
* **Navbar:** add container options ([f0054bf](https://github.com/illiteratewriter/reactstrap/commit/f0054bf6ef8945e591f79fe403ece3f33a5cef8a))
* **Placeholder:** add component ([0c9294c](https://github.com/illiteratewriter/reactstrap/commit/0c9294c44108310a84c7f2518bfd9d631d51e835))
* **PopoverContent:** add x-out-of-boundaries attribute ([607ce10](https://github.com/illiteratewriter/reactstrap/commit/607ce103475f2b3b0f25a2d22c61f5ce33204073)), closes [#1835](https://github.com/illiteratewriter/reactstrap/issues/1835)
* **Progress:** add aria props ([#1681](https://github.com/illiteratewriter/reactstrap/issues/1681)) ([#1787](https://github.com/illiteratewriter/reactstrap/issues/1787)) ([93f171d](https://github.com/illiteratewriter/reactstrap/commit/93f171d6ccb21745a43063fc175236f14df3ae5f))
* **Progress:** Add barStyle prop ([#2075](https://github.com/illiteratewriter/reactstrap/issues/2075)) ([27faa8e](https://github.com/illiteratewriter/reactstrap/commit/27faa8e5c575314070f1a35e1969c81e25b13942))
* remove CustomInput ([c0e8a68](https://github.com/illiteratewriter/reactstrap/commit/c0e8a68348c52aaee55168d8601fb534597b6313))
* remove form-control-file class ([f601576](https://github.com/illiteratewriter/reactstrap/commit/f6015765fb4988e484483b77b032ea00ebde59c2))
* remove InputGroupAddon ([322d0ad](https://github.com/illiteratewriter/reactstrap/commit/322d0add23f42e917f50286ba796eea4af64c6ae))
* remove Jumbotron component ([#2118](https://github.com/illiteratewriter/reactstrap/issues/2118)) ([2c912ab](https://github.com/illiteratewriter/reactstrap/commit/2c912abfb6027890d54ac091e18d515152cc395f))
* remove old InputGroupButtonDropdown ([3df07f6](https://github.com/illiteratewriter/reactstrap/commit/3df07f62b62a2648e13f344cdc3a8c864b6a8b07))
* replace form-control-range with form-range ([06868e2](https://github.com/illiteratewriter/reactstrap/commit/06868e28dd2a399297b5f9c9efc6b226487386b8))
* support form switch ([f403595](https://github.com/illiteratewriter/reactstrap/commit/f40359558e083306e33cb0bdafba9ad615a6bbe3))
* **TooltipPopoverWrapper:** scheduleUpdate as render prop ([#1792](https://github.com/illiteratewriter/reactstrap/issues/1792)) ([cda6fe9](https://github.com/illiteratewriter/reactstrap/commit/cda6fe9f3245031e15f4cc41a78f5c4362bc3c47))
* update input group to have type dropdown ([6c60226](https://github.com/illiteratewriter/reactstrap/commit/6c602261dd26f8eebf8a4ebd32e0bed8a08522ef))
* update positionedFix prop to strategy ([65bf0f0](https://github.com/illiteratewriter/reactstrap/commit/65bf0f0dae5732dc4a7daef59717fa35c0a2a07d))
* upgrade to popper 2 ([35840ef](https://github.com/illiteratewriter/reactstrap/commit/35840ef90ab6a3f5ae94a57cbde8331fc791870b))
* use form-select class with native select ([1e6204b](https://github.com/illiteratewriter/reactstrap/commit/1e6204b925e23d97d38532265f4828964e0e1638))


### Bug Fixes

* **#1289:** prevent error in Strict Mode ([#2672](https://github.com/illiteratewriter/reactstrap/issues/2672)) ([2695bfa](https://github.com/illiteratewriter/reactstrap/commit/2695bfaca471f187abe2464621509d0b09e64b9f))
* **#1680:** arrowClass not applied to arrow ([#2772](https://github.com/illiteratewriter/reactstrap/issues/2772)) ([aeaf180](https://github.com/illiteratewriter/reactstrap/commit/aeaf180701511377ab6a00830ccac4fb96e84028))
* **#2393:** captions visible twice ([c20fa93](https://github.com/illiteratewriter/reactstrap/commit/c20fa9397ea09811ed2b4da33b136f2aa1e98957))
* **#2410:** broken rounded corners for dropdown in input group ([c23d847](https://github.com/illiteratewriter/reactstrap/commit/c23d8478e9d25a2887484d9260c0d55322114ba7))
* **#2411:** remove scroll from body when modal open ([9d71faa](https://github.com/illiteratewriter/reactstrap/commit/9d71faada222f67683bf19acece3c20b3364a6df))
* **#2427:** error building esm files ([#2748](https://github.com/illiteratewriter/reactstrap/issues/2748)) ([04d571d](https://github.com/illiteratewriter/reactstrap/commit/04d571dcaa630ccbc8b8363ad06dad436f11780e))
* **#2467:** keyboard support for dropdown listbox ([#2584](https://github.com/illiteratewriter/reactstrap/issues/2584)) ([f04d3a7](https://github.com/illiteratewriter/reactstrap/commit/f04d3a7976bb8623d7d7453d5195cb1d57f5a6dd))
* **#2501:** Since React 18, errors on Popover and Tooltip ([1110c9c](https://github.com/illiteratewriter/reactstrap/commit/1110c9c39f6018cc0289b419ba887adbe434e301))
* **#2515:** Add missing Typescript exports for Placeholders ([f9e0dfa](https://github.com/illiteratewriter/reactstrap/commit/f9e0dfab37ae0ae2c2183964fa78dc863af320f3))
* **#2521:** fix `form-check-label`/`form-label` class on Label ([6aee08b](https://github.com/illiteratewriter/reactstrap/commit/6aee08b3bebdbdb1320c4f18382b28d5bc474dd7))
* **#2545:** change proptype of Spinner size ([2175cbb](https://github.com/illiteratewriter/reactstrap/commit/2175cbb8f1df23b851a693a968021dfa8be15a7b))
* **#2559:** Removed unused react import from stories ([a3ccab5](https://github.com/illiteratewriter/reactstrap/commit/a3ccab5fb737b6f3c3607ddee57f2fb0524448f5))
* **#2593:** fix key prop waring for dropdown ([#2594](https://github.com/illiteratewriter/reactstrap/issues/2594)) ([69526c1](https://github.com/illiteratewriter/reactstrap/commit/69526c1e1a24739fa5d6f13bc5aa4dfd49beeac5))
* **#2660:** dropdown closes for complex children ([#2673](https://github.com/illiteratewriter/reactstrap/issues/2673)) ([fa1fcc8](https://github.com/illiteratewriter/reactstrap/commit/fa1fcc84511582f5e22d42c73c2ff1bb8c805f9b))
* **#2662:** remove many instances of default props ([#2752](https://github.com/illiteratewriter/reactstrap/issues/2752)) ([b7d571c](https://github.com/illiteratewriter/reactstrap/commit/b7d571c777de6169de01da5cc14f2eb28988071a))
* **#2664:** close offcanvas when fade is false ([#2677](https://github.com/illiteratewriter/reactstrap/issues/2677)) ([dac3587](https://github.com/illiteratewriter/reactstrap/commit/dac3587bc16006697008ed6f248be268f49de4e5))
* **#2730:** import error ([#2733](https://github.com/illiteratewriter/reactstrap/issues/2733)) ([2547f3a](https://github.com/illiteratewriter/reactstrap/commit/2547f3acfd12299dc0f4e2a5863c5cf82a203ef4))
* **#2750:** Set data-bs-popper in dropdown menu ([7da730c](https://github.com/illiteratewriter/reactstrap/commit/7da730cf2a01550f5442d5c4425907ecc46242aa))
* **#2755:** make offcanvas example code readable ([#2768](https://github.com/illiteratewriter/reactstrap/issues/2768)) ([b932582](https://github.com/illiteratewriter/reactstrap/commit/b932582798911ebd57ad6735baf9f4fa21d8af7a))
* `form-row` was removed from Bootsttap 5 ([601845d](https://github.com/illiteratewriter/reactstrap/commit/601845d1c8b687d7c2a8494f5131c728ce1a532c))
* **Accordion:** fix incorrect props for accordion ([9c74d5b](https://github.com/illiteratewriter/reactstrap/commit/9c74d5b686ecdfed9786afe0750c6affff080cf7))
* **accordion:** type error of open in uncontrolledAccordionProps ([#2611](https://github.com/illiteratewriter/reactstrap/issues/2611)) ([b46a23c](https://github.com/illiteratewriter/reactstrap/commit/b46a23c897cca1e8c53729c5e222411028be169d))
* add a flag to DropdownMenu for Popper update ([74a9e4e](https://github.com/illiteratewriter/reactstrap/commit/74a9e4ef5ad8cfdf4e1ab2b9509a0e4ca52c8886))
* add common js bundle to exports field ([#2386](https://github.com/illiteratewriter/reactstrap/issues/2386)) ([c5bc0fe](https://github.com/illiteratewriter/reactstrap/commit/c5bc0fe54ea27cedb1a43a8dfe37738d13bd4eb6))
* **build:** set --compress false for microbundle build ([#2314](https://github.com/illiteratewriter/reactstrap/issues/2314)) ([26c85fb](https://github.com/illiteratewriter/reactstrap/commit/26c85fbdbf04399aab392565c3e6027023886538))
* **Button:** remove extra close icon in `btn-close` ([#2318](https://github.com/illiteratewriter/reactstrap/issues/2318)) ([e4affb4](https://github.com/illiteratewriter/reactstrap/commit/e4affb41a15eb0e1d723b3f835cafb8959b4f5d9))
* **Carousel:** ie11 compatibility changes([#799](https://github.com/illiteratewriter/reactstrap/issues/799)) ([#1585](https://github.com/illiteratewriter/reactstrap/issues/1585)) ([1fd2d22](https://github.com/illiteratewriter/reactstrap/commit/1fd2d22f1b82cba7cff8099973f9a33727b05bbd))
* convert functional components to be forwardRef components vs redefining them as such ([86578ab](https://github.com/illiteratewriter/reactstrap/commit/86578ab1f9e06653b03db06ed99263fba5e5e279))
* **CustomInput:** hidden attribute [#1741](https://github.com/illiteratewriter/reactstrap/issues/1741) ([#1777](https://github.com/illiteratewriter/reactstrap/issues/1777)) ([bb39b55](https://github.com/illiteratewriter/reactstrap/commit/bb39b55d521632162acaf5c1b45201f78dab9135))
* **docs:** fixed naming in Accordion module ([29beb09](https://github.com/illiteratewriter/reactstrap/commit/29beb09ed4a353ebc2d77611a51cea4d34409bf6))
* **docs:** remove storybook errors ([#2675](https://github.com/illiteratewriter/reactstrap/issues/2675)) ([d0f188b](https://github.com/illiteratewriter/reactstrap/commit/d0f188b31bf9ccd5f262a46bb42ea87dd644049d))
* dropdown with inNavbar bug ([18cc094](https://github.com/illiteratewriter/reactstrap/commit/18cc094afa8d4e95785d823eb735e06c28547d19))
* **DropdownMenu:** add types to updateOnSelect ([e5cd524](https://github.com/illiteratewriter/reactstrap/commit/e5cd52445ee5247a6408c75a212009f345f7270e))
* **DropdownMenu:** Prevent manual styles from overriding popper styles ([#1984](https://github.com/illiteratewriter/reactstrap/issues/1984)) ([dc2401b](https://github.com/illiteratewriter/reactstrap/commit/dc2401b388777b011bc6c75426a86a78013a2b8c))
* **DropdownToggle:** fix 0 value [#1496](https://github.com/illiteratewriter/reactstrap/issues/1496) ([#1780](https://github.com/illiteratewriter/reactstrap/issues/1780)) ([c4f86d5](https://github.com/illiteratewriter/reactstrap/commit/c4f86d56b490b5467dc922d399b3fc8843008521))
* ensure initial overflow status is stored when opening multiple modals ([c0191ec](https://github.com/illiteratewriter/reactstrap/commit/c0191ecbbba96f3652e6359111a258a33771e2c1))
* esm and lib folder not included in release ([e974d0c](https://github.com/illiteratewriter/reactstrap/commit/e974d0c180ebece9e35614da595e9cab2d8684b6))
* **exports:** Exports CloseButtom from index.d.ts ([ba815ee](https://github.com/illiteratewriter/reactstrap/commit/ba815eeb3999134ae5ae3e12a1dfdcbfaab00deb))
* **FormGroup:** dont pass switch prop to tag [#2415](https://github.com/illiteratewriter/reactstrap/issues/2415) ([b63981e](https://github.com/illiteratewriter/reactstrap/commit/b63981eb54af34e1332dfb84c670e2cbca937ee8))
* **Input:** Allow numbers for size prop ([#1948](https://github.com/illiteratewriter/reactstrap/issues/1948)) ([b4c45af](https://github.com/illiteratewriter/reactstrap/commit/b4c45afe658ee5008274fbf687b22d35dfe12c51))
* **Input:** Aria-invalid attribute ([#1782](https://github.com/illiteratewriter/reactstrap/issues/1782)) ([ca113f1](https://github.com/illiteratewriter/reactstrap/commit/ca113f1851e0ac97e910b3be0864e2cf202466a2))
* **InputGroup:** toggle if clicking dropdown input ([1adc147](https://github.com/illiteratewriter/reactstrap/commit/1adc147d600309705ad25116121b89ad65b6409d))
* issue where attributes could not be passed to the element ([19233ae](https://github.com/illiteratewriter/reactstrap/commit/19233ae45014045a6b103619b2b43fb4f386d02a))
* **Label:** add `form-label` class for labels of vertical forms ([#2317](https://github.com/illiteratewriter/reactstrap/issues/2317)) ([3bfce12](https://github.com/illiteratewriter/reactstrap/commit/3bfce12c4bdc9615399e8821629328f8a441d9b8))
* **Label:** migrate label to rtl ([#2665](https://github.com/illiteratewriter/reactstrap/issues/2665)) ([8c5cc2b](https://github.com/illiteratewriter/reactstrap/commit/8c5cc2bac0c219275896657db21f5c2ea5ecdffe))
* Make tooltips fade out ([#2041](https://github.com/illiteratewriter/reactstrap/issues/2041)) ([3fb5476](https://github.com/illiteratewriter/reactstrap/commit/3fb5476515aa01e658426e72dfbe5e7bc517b460))
* **Modal:** fix modal close immediately unmounted ([c8def29](https://github.com/illiteratewriter/reactstrap/commit/c8def29d6dffef344525ce85d801562357ccf85b))
* **Modal:** Trap focus on opened modal ([#1941](https://github.com/illiteratewriter/reactstrap/issues/1941)) ([bf46484](https://github.com/illiteratewriter/reactstrap/commit/bf46484d2ee1e0d570170d59152fcd0346bfe434))
* **Offcanvas:** make types match existing `direction` prop ([6e60f08](https://github.com/illiteratewriter/reactstrap/commit/6e60f08db14b0f7896c703f41fb6c4c2b7362fd6))
* **polyfill:** check that window exists before defining CustomEvent ([#1855](https://github.com/illiteratewriter/reactstrap/issues/1855)) ([74b6802](https://github.com/illiteratewriter/reactstrap/commit/74b6802bb463688256c7ba80eb25105a45b3b09a))
* **popover:** add default popper offset for popover ([cef32c6](https://github.com/illiteratewriter/reactstrap/commit/cef32c6a051fdfe532d6e3b1e86b8dcf60087558))
* **Popover:** Select correct parent target when target children clicked ([#2038](https://github.com/illiteratewriter/reactstrap/issues/2038)) ([6740a57](https://github.com/illiteratewriter/reactstrap/commit/6740a57268dd87704c0215aa45a7e38babb5b426))
* Prevent popover/tooltip rendering if target not resolved ([#2059](https://github.com/illiteratewriter/reactstrap/issues/2059)) ([de06e9f](https://github.com/illiteratewriter/reactstrap/commit/de06e9ff12e954c92ba0964e615723e9a44f9269))
* **Progress:** Fix parent element props being spread to children ([#1970](https://github.com/illiteratewriter/reactstrap/issues/1970)) ([c6a790c](https://github.com/illiteratewriter/reactstrap/commit/c6a790c7f4bdbfac0540d53896834638edf9c793))
* **Progress:** pass attributes to nested Progress bar ([#1919](https://github.com/illiteratewriter/reactstrap/issues/1919)) ([f3c2586](https://github.com/illiteratewriter/reactstrap/commit/f3c2586bbf1cc86459b5c2fd4cb025512aead432))
* properly pass in `isOpen` in modal test ([#2745](https://github.com/illiteratewriter/reactstrap/issues/2745)) ([8cb0515](https://github.com/illiteratewriter/reactstrap/commit/8cb051522ddfad48c08651604744caea25b5e68e))
* **reactstrap#2742:** Replace callback refs with React.createRef() and update to access ref.current ([e931957](https://github.com/illiteratewriter/reactstrap/commit/e9319578f7217db2422405fae33e3d5387e15eaf))
* revert v10 merge ([3392ce9](https://github.com/illiteratewriter/reactstrap/commit/3392ce924ad304e97cede43ddef013a88ef84a6e))
* **ToastHeader:** Remove charCode default property. ([#2343](https://github.com/illiteratewriter/reactstrap/issues/2343)) ([03bbd15](https://github.com/illiteratewriter/reactstrap/commit/03bbd1508a2262a34a8960e1faa95585689fbaea)), closes [#2338](https://github.com/illiteratewriter/reactstrap/issues/2338)
* **TooltipPopoverWrapper:** replacing find with filter to preve… ([#1776](https://github.com/illiteratewriter/reactstrap/issues/1776)) ([54648b6](https://github.com/illiteratewriter/reactstrap/commit/54648b69c43b95c60a53417cb00c72e6ff2eada0)), closes [#1774](https://github.com/illiteratewriter/reactstrap/issues/1774)
* treeshaking ([#2708](https://github.com/illiteratewriter/reactstrap/issues/2708)) ([fa46b94](https://github.com/illiteratewriter/reactstrap/commit/fa46b941004bfd37eb5bd2fcdce435d1ddac5066))
* **types:** add 'swtch' to `InputType` ([#2340](https://github.com/illiteratewriter/reactstrap/issues/2340)) ([302d41e](https://github.com/illiteratewriter/reactstrap/commit/302d41eb20054d5bf9c6fd1ddc651dbafcce46f1))
* **types:** Add missing innerRef typings ([#1994](https://github.com/illiteratewriter/reactstrap/issues/1994)) ([fe24f69](https://github.com/illiteratewriter/reactstrap/commit/fe24f69be2dc9953896c49be73254f7787ad34ff)), closes [#1993](https://github.com/illiteratewriter/reactstrap/issues/1993)
* **types:** export AccordionBody types ([#2312](https://github.com/illiteratewriter/reactstrap/issues/2312)) ([d4c184b](https://github.com/illiteratewriter/reactstrap/commit/d4c184bd5c738b0905d02e56a6f2705e2cd9bb70))
* **types:** export UncontrolledAccordion types ([#2313](https://github.com/illiteratewriter/reactstrap/issues/2313)) ([f7d5cd6](https://github.com/illiteratewriter/reactstrap/commit/f7d5cd664417cbbeb3e17f6ab0097ec024647c64))
* **types:** Fix Col and Input types ([#2008](https://github.com/illiteratewriter/reactstrap/issues/2008)) ([363dfbe](https://github.com/illiteratewriter/reactstrap/commit/363dfbe6a46ef04c61f0b249bd5c0a80ec1c1e3e))
* **types:** Fix reference to CSSModule ([#2007](https://github.com/illiteratewriter/reactstrap/issues/2007)) ([54afca4](https://github.com/illiteratewriter/reactstrap/commit/54afca47879fbb8a2713b57ff452fa566e5255d1))
* **types:** import React for UncontrolledAccordion type defs ([#2292](https://github.com/illiteratewriter/reactstrap/issues/2292)) ([54df194](https://github.com/illiteratewriter/reactstrap/commit/54df194dd36205d782ec1985b383a1e18137186b))
* **types:** remove duplicate types/lib/index.d.ts ([#2316](https://github.com/illiteratewriter/reactstrap/issues/2316)) ([52bd719](https://github.com/illiteratewriter/reactstrap/commit/52bd7192c453c5333c00603f6bc8555f4e10b5f6))
* **types:** use types from @popperjs/core ([10fd0b2](https://github.com/illiteratewriter/reactstrap/commit/10fd0b28d661b368bead1006ea075435ad911d55))
* Typo in Tabs Example ([#1795](https://github.com/illiteratewriter/reactstrap/issues/1795)) ([66754d4](https://github.com/illiteratewriter/reactstrap/commit/66754d4217f6f3455acfb4c1a98508464dfaafe2))
* **UncontrolledDropdown:** Fix onToggle - a consistent isOpen value ([ee54164](https://github.com/illiteratewriter/reactstrap/commit/ee54164a142c9ae4d43a2a8db4f6a5c088b4eff9))
* Use the new `nodeRef` API for `Collapse` ([9527654](https://github.com/illiteratewriter/reactstrap/commit/9527654b74e5695efbb31dff0ebd29812cdef1ee))


### Miscellaneous

* **Button:** convert button to use hooks ([19f85d3](https://github.com/illiteratewriter/reactstrap/commit/19f85d30d3c01f8f60762db55b123efddb4d152b))
* **Carousel:** Update Carousel from legacy context ([1c6db58](https://github.com/illiteratewriter/reactstrap/commit/1c6db58e1e4b2917aa8c0bb205ca1beff49cdef9))
* release 9.1.6 ([f32f3d2](https://github.com/illiteratewriter/reactstrap/commit/f32f3d247b767592a80091e3f1733946b2f74ada))
* **TabContent:** remove obsolete `react-lifecycles-compat` ([e1915e8](https://github.com/illiteratewriter/reactstrap/commit/e1915e87970fb22ae9ebd89ccc13b61b0b856000))
